...
Usage:
- Run this file: `python great_expectations/run_example_checkpoint.py`.
...
data_context: DataContext = DataContext(context_root_dir=str(Path(os.path.join(Path(__file__).resolve().parent))))
